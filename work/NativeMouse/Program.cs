...
sealed class MainForm : Form
{
    ...
    bool active, ctrl, alt; int speed = 50, lastMoveKey = 0, moveRepeat = 0, lastMoveTick; Label state; Button toggle; HookProc proc; IntPtr hook;
    ...
    public MainForm()
    {
        ...
        var help = new Label { Left = 18, Top = 52, Width = 465, Height = 105, Text = "Ctrl+Alt+M activa/desactiva el modo ratón.\r\n\r\nFlechas o teclado numérico 8/4/6/2 mueven; Z hace clic izquierdo; . hace clic derecho; Retroceso vuelve al teclado normal.\r\n\r\nEl botón también cambia el modo." };
